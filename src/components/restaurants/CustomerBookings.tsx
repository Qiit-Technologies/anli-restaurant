                                ...
                                <div className="flex flex-col md:flex-row gap-3 md:gap-5">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex justify-between items-center pt-3 border-t border-gray-50">
                                            ...
                                            <Link 
                                                href={`/${booking.hotel?.name.toLowerCase().trim().replace(/\s+/g, '-').replace(/[^\w-]+/g, '').replace(/--+/g, '-') || 'restaurant'}/${booking.hotel?.id}/reservation`}
...
function FavoriteCard({ restaurant }: { restaurant: any }) {
    ...
    return (
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-xl transition-all group h-full flex flex-col">
            <Link href={`/${restaurant.id}`} className="block relative h-48 overflow-hidden">
                <Image 
